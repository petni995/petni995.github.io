...
Game.Screen.startScreen = {
    ...
    render: function(display) {
        ...
        display.drawText(1,2, "Press [Enter or s] to start!");
    },
...
Game.Screen.playScreen = {
  ...
  enter: function() {
    ...
    render: function(display) {
        ...
        // Render player HP and attack/defence
        var stats = this._messagecolor;
        stats += vsprintf('HP: %d/%d ', [this._player.getHp(), this._player.getMaxHp()]);
        stats += vsprintf('   A/D:  %d/%d ', [this._player.getAttackValue(), this._player.getDefenseValue()]);
    ...
    handleInput: function(inputType, inputData) {
            ...
            if (inputData.keyCode === ROT.VK_H || inputData=='H') {
              ...
              this.move(-1, -1, 0);
                ...
                this.move(1, 1, 0);
                    ...
                    return;
             } else if (inputData.keyCode === ROT.VK_E || inputData=='E') {
                    // Show the eat screen
                    this.showItemsSubScreen(Game.Screen.eatScreen, this._player.getItems(),
                       'You have nothing to eat.');
                    return;
             } else if (inputData.keyCode === ROT.VK_W || inputData=='W'|| inputData=='w') {
                    if (inputData=='W') {
            ...
            if (keyChar === '>' || inputData=='>') {
                this.move(0, 0, 1);
            } else if (keyChar === '<' || inputData=='<') {
                this.move(0, 0, -1);
            } else {
                // Not a valid key
                return;
...
Game.Screen.ItemListScreen.prototype.handleInput = function(inputType, inputData) {
    if (inputType === 'keydown') {
      ...
      } else if (this._canSelectItem && this._hasNoItemOption && inputData === '0') {
            this._selectedIndices = {};
            this.executeOkFunction();        // Handle pressing a letter if we can select
